...
class getReportIdCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getkeywordreportid:sbkeyword';
                    ...
                    if (!empty($accessToken)) {
                        try {
                            ...
                            if (!empty($body)) {
                                ...
                                $storeArray['reportType'] = "Keyword_SB";
                                ...
                                // store report status
                                AMSModel::insertTrackRecord('report name : Keyword SB Report Id' . ' profile id: ' . $single->id, 'record found');
                            } else {
                                // store report status
                                AMSModel::insertTrackRecord('report name : Keyword SB Report Id' . ' profile id: ' . $single->id, 'not record found');
                            }
                            if (!empty($DataArray)) {
