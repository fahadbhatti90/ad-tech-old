...
class getReportIdCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gettargetreportid:targets';
    ...
    {
        Log::info("filePath:Commands\Ams\Target\getReportIdCron. Start Cron.");
        ...
        Log::info("filePath:Commands\Ams\Target\getReportIdCron. End Cron.");
    }
}
